...
train_dataset = TrainColorizerDataset(color_dir, color_dir, transform=data_transform)
eval_dataset = TrainColorizerDataset(ecolor_dir, ecolor_dir, transform=data_transform)
